...
public class CalendarController {
    ...
    @Operation(summary = "월별 캘린더 조회", description = "유저가 보유 중인 일정을 월별로 조회한다.")
    @GetMapping("/monthly")
    ...
    @Operation(summary = "일별 캘린더 조회", description = "유저가 보유 중인 일정을 일별로 조회한다.")
    @GetMapping("/daily")
    ...
    @Operation(summary = "D-Day 조회", description = "유저가 설정한 D-Day 일정 정보를 조회한다.")
    @GetMapping("/d-day")
